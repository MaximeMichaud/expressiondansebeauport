...
chown 1654:1654 /app/logs /app/backups /app/app-data/uploads /home/app/.aspnet/DataProtection-Keys 2>/dev/null || true

if [ -d /app/seed-uploads ]; then
  find /app/seed-uploads -type f | while IFS= read -r source; do
    relative_path=${source#/app/seed-uploads/}
    destination="/app/app-data/uploads/$relative_path"
