...
namespace Persistence.Migrations
{
    ...
    [Migration("20260514221525_AddReviewsAndSectionTextToSiteSettings")]
    partial class AddReviewsAndSectionTextToSiteSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.SiteSettings", b =>
                {
                    ...
                    b.Property<string>("BannerText")
                        ...
                        .HasDefaultValue("Actualités du moment");
                    ...
                    b.Property<bool>("IsBannerEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<string>("MaintenanceMessage")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasDefaultValue("Le site est en maintenance. Revenez bientôt !");

                    b.Property<int>("MaintenanceRetryAfter")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.UserGroupNotificationPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserGroupNotificationPreferences", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.UserNotificationPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("NotifyOnAnnouncement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<bool>("NotifyOnGroupPost")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
