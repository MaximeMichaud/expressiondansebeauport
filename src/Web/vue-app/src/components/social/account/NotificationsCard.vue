  ...
  <section class="soc-account__card">
    ...
    <div class="soc-account__card-body">
      ...
      <div v-else class="space-y-3">
        ...
        />
        <p v-if="permission === 'denied'" class="text-sm text-red-600">
          Les notifications ont été bloquées. Pour les réactiver, allez dans les paramètres de votre navigateur.
        </p>

        <div v-if="isSubscribed" class="mt-2 ml-4 pl-3 border-l-2 space-y-3" :style="{ borderColor: 'var(--soc-border)' }">
...
async function onMasterToggle(enabled: boolean) {
  if (enabled) {
