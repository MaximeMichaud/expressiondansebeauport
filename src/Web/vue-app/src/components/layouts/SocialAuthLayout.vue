<template>
  <div :class="['soc-auth', isDarkMode && 'soc-auth--dark']">
    <!-- Theme toggle -->
    <button @click="toggleTheme" class="soc-auth__theme-toggle" :title="isDarkMode ? 'Mode clair' : 'Mode sombre'" :aria-label="isDarkMode ? 'Activer le mode clair' : 'Activer le mode sombre'">
    ...
    <main class="soc-auth__card" aria-label="Authentification EDB Social">
