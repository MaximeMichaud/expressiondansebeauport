...
import {Administrator, AuditLog, BackupRecord, ErrorLog, FooterPartner, HelpArticle, MediaFile, NavigationMenu, NavigationMenuItem, Page, PageRevision, PageRevisionListItem, SiteHealth, SiteSettings, SocialLink, User, Group, GroupMember, Post, Comment, Conversation, Message} from "@/types/entities"
